      ...
      return (
        (a.prototype = Object.assign({}, a.prototype, {
          ...
          _updateVariantInfo: function () {
            //load metafield data
            const allVariantMetafieldData = JSON.parse(
              document.querySelector("#variant_metafield_data").textContent
            );
            if (
              allVariantMetafieldData[this.currentVariant.id].packquantity !==
              ""
            ) {
              document.getElementById("pack_quantity").innerHTML =
                allVariantMetafieldData[this.currentVariant.id].packquantity;
            }
            if (
              allVariantMetafieldData[this.currentVariant.id].cartonquantity !==
              ""
            ) {
              document.getElementById("carton_quantity").innerHTML =
                allVariantMetafieldData[this.currentVariant.id].cartonquantity;
            }
            document.getElementById("weight_each").innerHTML =
              allVariantMetafieldData[this.currentVariant.id].weightper;
            document.getElementById("weight_pack").innerHTML =
              allVariantMetafieldData[this.currentVariant.id].weightpack;
            document.getElementById("weight_carton").innerHTML =
              allVariantMetafieldData[this.currentVariant.id].weightcarton;
            if (
              allVariantMetafieldData[this.currentVariant.id].threads !== ""
            ) {
              document.getElementById("bolt_thread").innerHTML =
                allVariantMetafieldData[this.currentVariant.id].threads;
            }
            if (
              allVariantMetafieldData[this.currentVariant.id].diameter !== ""
            ) {
              document.getElementById("diameter").innerHTML =
                allVariantMetafieldData[this.currentVariant.id].diameter;
            }
            document.getElementById("variant_description").innerHTML =
              allVariantMetafieldData[
